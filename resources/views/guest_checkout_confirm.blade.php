...
@section('title','Guest Order | '.config('app.name'))
            ...
            <div class="center-1">
                <div class="page checkout-page">
                    <div class="page-title">
                        <h1>Guest Order Confirmation Info</h1>
                    </div>
                    <div class="page-body checkout-data">
                        <ol class="opc" id="checkout-steps">
                            <form action="{{ route('guest.checkout.store') }}" id="co-payment-method-form" method="post">
                                {{ csrf_field() }}
                                ...
                                {{--                                <input type="hidden" name="DeliveryCharge" value="{{ $data[0]['DeliveryCharge'] }}">--}}
                                ...
                                <div class="buttons" id="payment-method-buttons-container">
                                    ...
                                    <input type="submit" class="button-1 payment-method-next-step-button" value="Guest Order Confirm" />
                                </div>
                            </form>
                        </ol>
                    </div>
